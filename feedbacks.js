...
module.exports = function (self) {
  ...
  feedbacks["playback_source_type"] = {
    ...
    callback: function (feedback) {
      if (self.currentTrack.source) {
        return (
          self.currentTrack.source.__typename === feedback.options.source_type
        );
      } else {
        return false;
      }
  ...
  feedbacks["playback_source_playlist"] = {
    ...
    callback: function (feedback) {
      if (self.currentTrack.source.__typename === "Playlist") {
        ...
        return (
          self.currentTrack.source.playlist.id === feedback.options.playlist
        );
      } else {
        return false;
      }
  ...
  feedbacks["current_track_title"] = {
    ...
    callback: function (feedback) {
      if (self.currentTrack) {
        return (
          self.currentTrack.playable.title === feedback.options.track_title
        );
      } else {
        return false;
      }
  ...
  feedbacks["upcoming_track_title"] = {
    ...
    callback: function (feedback) {
      if (self.upcomingTrack) {
        return (
          self.upcomingTrack.playable.title === feedback.options.track_title
        );
      } else {
        return false;
      }
